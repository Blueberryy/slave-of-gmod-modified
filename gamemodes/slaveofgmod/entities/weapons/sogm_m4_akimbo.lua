...
SWEP.SingleClass 			= "sogm_m4"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_rif_m4a1.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(13.869, 3.365, -2.198), angle = Angle(7.413, -13.143, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
