...
SWEP.SingleClass = "sogm_mp5"
SWEP.Akimbo = true

/*SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_smg_mp5.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.27, 1.592, -3.889), angle = Angle(7.399, -10.671, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}*/
