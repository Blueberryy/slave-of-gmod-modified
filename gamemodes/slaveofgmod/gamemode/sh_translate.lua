...
function meta:ChatPrintTranslated(translateid, ...)
	if ... ~= nil then
		LocalPlayer():ChatPrint(translate.ClientFormat(LocalPlayer, translateid, ...))
	else
		LocalPlayer():ChatPrint(translate.ClientGet(LocalPlayer, translateid))
	end
end
