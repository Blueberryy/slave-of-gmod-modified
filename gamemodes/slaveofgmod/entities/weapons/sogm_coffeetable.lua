...
SWEP.WorldModel			= Model ( "models/props/cs_office/Table_coffee.mdl"  ) 
...
SWEP.MapOnly 			= true
SWEP.Durability 		= math.random(2,3)
	...
	if self.Durability then
		...
		if self.Durability == 0 then
			...
			if IsValid( gibs ) then
				gibs:SetModel( "models/props/cs_office/Table_coffee.mdl" )
...
SWEP.WElements = {
	["coffeetable"] = { type = "Model", model = "models/props/cs_office/Table_coffee.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(11.399, -6.748, -13.716), angle = Angle(-4.204, 2.535, 64.022), size = Vector(0.644, 0.644, 0.644), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
