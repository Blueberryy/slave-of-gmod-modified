...
SWEP.SingleClass 			= "sogm_tmp"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_smg_tmp.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.956, 1.707, -3.286), angle = Angle(2.529, -9.36, -3.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
