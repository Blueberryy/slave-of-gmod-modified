...
SWEP.SingleClass 			= "sogm_ak47"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_rif_ak47.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(12.953, 2.453, -3.335), angle = Angle(3.342, -7.212, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
