...
SWEP.SingleClass 			= "sogm_famas"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_rif_famas.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(13.677, 3.778, -2.718), angle = Angle(5.811, -14.459, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
