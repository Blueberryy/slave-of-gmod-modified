...
SWEP.SingleClass = "sogm_usp"
SWEP.Akimbo = true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_pist_usp.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.348, 1.345, -2.622), angle = Angle(0, -9.11, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
