...
SWEP.SingleClass 			= "sogm_p90"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_smg_p90.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.414, 1.937, -3.444), angle = Angle(6.71, -10.459, -0.541), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
