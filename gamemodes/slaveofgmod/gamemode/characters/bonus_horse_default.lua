CHARACTER.Reference = "horse default"

CHARACTER.Name = "Horse Default"
...
CHARACTER.WElements = {
	...
	["horse"] = { type = "Model", model = "models/props_c17/statue_horse.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "dummy", pos = Vector(-43.93, 1.888, 33.617), angle = Angle(20.305, 60.858, 140.772), size = Vector(0.289, 0.289, 0.289), color = Color(228, 31, 229, 255), surpresslightning = true, material = "models/shiny", skin = 0, bodygroup = {} },
...
function CHARACTER:OnSpawn( pl )
	if pl:IsNextBot() then
		...
		//pl:SetColor( Color( math.random( 50, 170 ), 30, math.random( 50, 170 ) ) )
		pl:SetNextBotColor( Color( math.random( 50, 170 ), 30, math.random( 50, 170 ) ) )
	end
end