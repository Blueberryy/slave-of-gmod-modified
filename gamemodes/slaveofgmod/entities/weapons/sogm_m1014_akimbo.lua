...
SWEP.SingleClass 			= "sogm_m1014"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_shot_xm1014.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(13.44, 3.483, -2.398), angle = Angle(7.984, -14.009, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
