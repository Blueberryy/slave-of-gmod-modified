...
SWEP.SingleClass 			= "sogm_ump"
SWEP.Akimbo 				= true

SWEP.WElements = {
	["1"] = { type = "Model", model = "models/weapons/w_smg_ump45.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.068, 1.774, -3.734), angle = Angle(2.933, -7.166, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
